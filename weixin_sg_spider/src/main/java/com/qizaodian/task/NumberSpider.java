...
public class NumberSpider {
	//需要修改的地方
	private static String keyword = "银行";
	...
	public boolean spiderDetail(int i) {
		...
		String url="http://weixin.sogou.com/weixin?query="+ keyword+ "&_sug_type_=&_sug_=n&type=1&page="+i+"&ie=utf8";
		...
		if (resultsElements.size() == 0) {
			...
			for (Element element : aElements) {
				...
				Elements numEl = element.select("div>div.txt-box>p.info>span.line-s");
